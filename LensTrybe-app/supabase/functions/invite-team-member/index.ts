        ...
        html: `
          <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 600px; margin: 0 auto; background: #0f0f0f; color: #e8e8e8; border-radius: 16px; overflow: hidden;">
            <div style="background: #141414; padding: 40px 40px 32px; border-bottom: 1px solid #1e1e1e; text-align: center;">
              <div style="font-size: 28px; font-weight: 900; color: #39ff14; letter-spacing: -0.5px;">LensTrybe</div>
            ...
            <div style="padding: 40px;">
              ...
              <div style="text-align: center; margin: 32px 0;">
                <a href="${joinUrl}" style="display: inline-block; background: #39ff14; color: #000; font-weight: 700; font-size: 16px; padding: 14px 36px; border-radius: 10px; text-decoration: none; letter-spacing: -0.2px;">Accept Invitation</a>
              </div>
              ...
              <p style="font-size: 12px; color: #39ff14; word-break: break-all; margin: 0 0 20px;">${joinUrl}</p>
            ...
            <div style="background: #141414; padding: 20px 40px; border-top: 1px solid #1e1e1e; text-align: center;">
              <div style="font-size: 12px; color: #444;">LensTrybe &bull; <a href="https://lenstrybe.com" style="color: #39ff14; text-decoration: none;">lenstrybe.com</a></div>
            </div>
          </div>
        `,
      }),
