...
const M = ['O', 'N', 'D', 'J', 'F', 'M', 'A', 'M', 'J', 'J', 'A', 'S'], MONTHS = ['Oct 2025', 'Nov 2025', 'Dec 2025', 'Jan 2026', 'Feb 2026', 'Mar 2026', 'Apr 2026', 'May 2026', 'Jun 2026', 'Jul 2026', 'Aug 2026', 'Sep 2026']
...
export default function Chart({ id = 'c', paid = PAID, quoted = Q }) {
  ...
  const H = 150, pad = { l: 34, r: 8, t: 12, b: 20 }, max = 12000
  ...
  const cur = hov ?? 8, i = cur, showTip = hov != null
    ...
    <div className="chart" ref={box}>
      ...
      <div className="cw" onMouseMove={move} onMouseLeave={() => setHov(null)} onTouchMove={e => { const t = e.touches[0]; if (t) move({ currentTarget: e.currentTarget, clientX: t.clientX }) }}>
        <svg viewBox={`0 0 ${W} ${H}`} preserveAspectRatio="none">
          ...
          {[0, 6000, 12000].map(v => <g key={v}><line x1={pad.l} x2={W - pad.r} y1={y(v)} y2={y(v)} stroke="currentColor" strokeOpacity=".1" /><text x={pad.l - 6} y={y(v) + 4} fontSize="10" fill="currentColor" fillOpacity=".5" textAnchor="end" fontFamily="Inter,sans-serif">{v ? '$' + v / 1000 + 'k' : '0'}</text></g>)}
