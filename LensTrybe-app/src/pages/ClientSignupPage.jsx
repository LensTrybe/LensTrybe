...
export default function ClientSignupPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      try { await supabase.functions.invoke('send-welcome-email', { body: { user_id: uid, name: [firstName.trim(), lastName.trim()].filter(Boolean).join(' '), role: 'client' } }) } catch { /* best effort */ }
