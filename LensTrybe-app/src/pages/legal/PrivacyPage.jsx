...
export default function PrivacyPage() {
  ...
  const sections = [
    ...
    { title: '5. Data Storage and Security', body: 'Your data is stored on servers provided by our infrastructure partners. LensTrybe implements reasonable technical and organisational measures to protect your personal information from unauthorised access, loss, or disclosure.\n\nNo method of transmission over the internet is completely secure. While we take reasonable steps to protect your data, we cannot guarantee absolute security.\n\nWe retain your personal information for as long as your account is active or as needed to provide our services. If you delete your account, it is hidden straight away and then permanently deleted, including the files you uploaded, 30 days after your request. You can reactivate your account at any time within those 30 days. After deletion we keep only a minimal record that the deletion took place, plus any records we are required to retain for legal or compliance purposes (for example, payment records held by our payment provider).' },
    { title: '6. Your Rights', body: 'Under the Australian Privacy Act 1988, you have the right to:\n\n• Access the personal information we hold about you, including downloading a copy of your account data at any time (Settings > Your Data for creatives, Account & Data for clients)\n• Request correction of inaccurate or incomplete information\n• Request deletion of your personal information (subject to legal obligations)\n• Opt out of non-essential communications\n\nTo exercise any of these rights, contact us at privacy@lenstrybe.com. We will respond within 1-3 business days.' },
