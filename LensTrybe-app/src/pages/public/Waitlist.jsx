    ...
    <section className="hiw join wl dark darkhero">
      ...
      <div className="jgrid">
        <div className="jpitch">
          ...
          <p className="sub">{open ? 'LensTrybe is live on the east coast, starting in South East Queensland. Creatives join in a minute; clients search free.' : outside ? (region === 'INTL' ? 'LensTrybe is built for Australian photographers and videographers and opens there first, starting in South East Queensland on 1 October. Leave an email and you hear the moment it goes wider.' : 'LensTrybe is coming to ' + place + '. A home for photographers and videographers where you keep everything you earn, and the ask brings clients to you. Leave an email: you are first through the door when we open near you, with three months free on any paid plan.') : 'A home for Australian photographers and videographers where you keep everything you earn. Leave an email and you are first through the door, with three months free on any paid plan.'}</p>
