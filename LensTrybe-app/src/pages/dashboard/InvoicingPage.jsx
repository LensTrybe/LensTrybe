            ...
            <div style={invoiceDocSurface}>
              ...
              <div style={{ marginBottom: 24, paddingBottom: 16, borderBottom: `1px solid ${brandAccent}` }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                  ...
                  <input type="tel" inputMode="tel" value={newInvoice.client_phone} onChange={e => setNewInvoice(p => ({ ...p, client_phone: e.target.value }))} placeholder="Phone (optional)" style={{ padding: '8px 12px', border: `1px solid ${brandAccent}40`, borderRadius: 6, fontSize: 14, color: '#111', width: '100%', boxSizing: 'border-box' }} />
