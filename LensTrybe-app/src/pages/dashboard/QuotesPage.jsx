...
export default function QuotesPage() {
  ...
  // Opened from a booking ('Send a quote'): start a new quote with the client's details.
  useEffect(() => {
            ...
            <div style={quoteDocSurface}>
              <div style={{ margin: isMobile ? '-16px -16px 16px -16px' : '-40px -48px 24px -48px', padding: isMobile ? '14px 16px' : '20px 48px', ...quoteHeaderBg, color: quoteHeaderTextColor }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexDirection: isMobile ? 'column' : 'row', gap: isMobile ? 10 : 0 }}>
                  <div style={{ display: 'flex', alignItems: 'flex-start', gap: 16 }}>
                    {brandLogo && <img loading="lazy" decoding="async" src={brandLogo} alt="Logo" style={{ height: 48, width: 'auto', maxWidth: 140, objectFit: 'contain' }} />}
                    <div>
              ...
              <div style={{ marginBottom: 24 }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                  ...
                  <input type="tel" inputMode="tel" value={newQuote.client_phone} onChange={e => setNewQuote(p => ({ ...p, client_phone: e.target.value }))} placeholder="Phone (optional)" style={{ padding: '8px 12px', border: `1px solid ${quoteBrandAccent}40`, borderRadius: 6, fontSize: 14, color: '#111', width: '100%', boxSizing: 'border-box' }} />
              ...
              <div style={{ marginBottom: 32 }}>
                ...
                {editingQuote ? (
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                    ...
                    <input type="tel" inputMode="tel" value={editForm.client_phone} onChange={e => setEditForm(p => ({ ...p, client_phone: e.target.value }))} style={{ padding: '6px 10px', border: '1px solid #d1d5db', borderRadius: 6, fontSize: 14, color: '#111' }} placeholder="Phone" />
