...
const nav = [
  ...
  { label: 'Portfolio', path: '/dashboard/portfolio-design/portfolio', icon: '▦', section: 'Portfolio' },
  ...
  { label: 'Insights', path: '/dashboard/business/insights', icon: '▲', section: 'Business', feature: 'insights' },
  ...
  { label: 'Requests', path: '/dashboard/my-work/booking-requests', icon: '📥', section: 'Work' },
